...
public class Fact_5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootview = inflater.inflate(R.layout.fact_5, container, false);
        ...
        final boolean xpdelivered = pref.getBoolean("fact5delivered",false);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (xpdelivered==false) {
                    ...
                    editor.putBoolean("fact5delivered",true)
                            .apply();
    ...
    //Lien exterieur
    public String lien = "http://birdeo.com/" ;
